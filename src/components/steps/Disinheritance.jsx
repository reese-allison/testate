...
export function Disinheritance({ data, onChange, residenceState = 'FL' }) {
  ...
  } = useArrayItemManager('disinheritance', data.persons, onChange, 'disinheritPerson', 'persons')
    ...
    <div className="space-y-6">
      <Alert variant="warning" title="Important: Disinheritance Considerations">
        ...
        <ul className="list-disc list-inside space-y-1 mt-2">
          <li>
            A surviving spouse has rights to a portion of the estate regardless of the will
            (elective share)
          </li>
          ...
          {data.include && (
            <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              <p className="text-sm text-gray-600 dark:text-gray-300">
                By explicitly naming individuals you wish to disinherit, you make clear that the
                omission is intentional, which can help prevent challenges to your will.
              </p>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      aria-label={`Remove disinherited person ${index + 1}${person.name ? `: ${person.name}` : ''}`}
                    >
              ...
              <button
                type="button"
                onClick={addPerson}
                aria-label="Add a person to disinherit from your will"
                className="
      ...
      {!data.include && (
        <Card title="No Disinheritance">
          <p className="text-gray-600 dark:text-gray-300">
            ...
            Your estate will be distributed according to your other instructions, and anyone not
            named as a beneficiary simply won't receive anything.
          </p>
          <p className="mt-3 text-sm text-gray-600 dark:text-gray-300">
            However, if you have family members who might expect to inherit (especially children or
            a spouse) and you don't want them to, it's safer to explicitly disinherit them to
            prevent potential will contests.
          </p>
        </Card>
      )}
