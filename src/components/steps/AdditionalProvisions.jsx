...
export function AdditionalProvisions({ data, onChange, errors = {}, residenceState = 'FL' }) {
  ...
  // Pet handlers using shared hook
  const {
    addItem: addPet,
    updateItem: updatePet,
    removeItem: removePet,
  } = useArrayItemManager('pets', pets.items, onChange, 'pet', 'items')

  // Real property handlers using shared hook
  const {
    addItem: addProperty,
    updateItem: updateProperty,
    removeItem: removeProperty,
  } = useArrayItemManager('realProperty', realProperty.items, onChange, 'property', 'items')
          ...
          {pets.include && (
            <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      aria-label={`Remove pet ${index + 1}${pet.name ? `: ${pet.name}` : ''}`}
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      error={errors[`pet_${index}_caretaker`]}
                    />
                    <FormField
              ...
              <button
                type="button"
                onClick={addPet}
                aria-label="Add a pet to your will"
                className="
          ...
          {realProperty.include && (
            <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-red-500 hover:text-red-700 p-1"
                      aria-label={`Remove property ${index + 1}${property.address ? `: ${property.address}` : ''}`}
                    >
                      <Trash2 className="w-4 h-4" aria-hidden="true" />
                    </button>
                  </div>
                  ...
                  <FormField
                    ...
                    error={errors[`property_${index}_address`]}
                  />
                  ...
                  <FormField
                    ...
                    error={errors[`property_${index}_beneficiary`]}
                  />
              ...
              <button
                type="button"
                onClick={addProperty}
                aria-label="Add a property to your will"
                className="
                  w-full py-3 px-4 rounded-lg border-2 border-dashed
                  border-gray-300 dark:border-gray-600
                  text-gray-600 dark:text-gray-300
